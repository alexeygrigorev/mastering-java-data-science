...
public class BingPageFeatureExtractor {

    private static final Logger LOGGER = LoggerFactory.getLogger(BingPageFeatureExtractor.class);
    ...
    private static void calculateFeatures(UrlRepository urls) throws IOException, FileNotFoundException {
        ...
        try (PrintWriter pw = new PrintWriter("bing-ranked-pages.json")) {
