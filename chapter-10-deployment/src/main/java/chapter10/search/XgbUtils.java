...
public class XgbUtils {
    ...
    public static DMatrix wrapData(double[][] X, double[] y) throws XGBoostError {
        int nrow = X.length;
    ...
    public static DMatrix wrapData(double[][] X) throws XGBoostError {
        int nrow = X.length;
        List<LabeledPoint> points = new ArrayList<>();
    ...
    public static double[] predict(Booster model, double[][] X) throws XGBoostError {
        DMatrix dmatrix = wrapData(X);
